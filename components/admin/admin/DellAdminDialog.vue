  ...
  >
    ...
    >
      ...
      <div class="flex items-center justify-between">
        <MainHeading text="Elimine el Administrador" />
        <button
          class="
            rounded-full
            p-2
...
import { getDellAdminQuery } from "~/querys/dellAdmin";
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const dellAdminQuery = getDellAdminQuery(+props.selectedAdminId);
    const {
      loading: isLoading,
      setToken,
      load,
